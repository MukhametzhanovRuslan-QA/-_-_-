...
TOKEN = '5831470375:AAG8kgT38e5wpjtFyRVV_bBRS47-meOjt6Y'
...
def start_message_handler(message: types.Message):
    ...
    bot.send_message(
        ...
        "Выберите сколько пользователей тебе нужно 👇🏻",
...
def message_handler(message: types.Message):
    ...
    bot.send_message(
        chat_id=message.chat.id,
        text="Вы великолепны. Нужны еще данные? можете выбрать еще раз 👇🏻",
        reply_markup=main_menu_reply_markup
    )
